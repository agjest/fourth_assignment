...
Her har vi forsøkt andre metoder, men til ingen hell. Gode forsøk, men det var altså plm() som ble forvirret av list-columns. Jeg kom på sporet siden plm() klaget om noe lm (som jo lå i variabelen model (en list-column) som den ikke forsto.)
